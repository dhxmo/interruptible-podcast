...
var AudioContext = window.AudioContext || window.webkitAudioContext,
	...
	Recorder = function (e = {}) {
		...
		(this.state = "inactive"),
			(this.config = Object.assign(
				{
					...
					encoderFrameSize: 20,
					encoderPath:
						self.location.origin + "/web/dist/encoderWorker.min.js",
			...
			(this.encoderWorkerUrl = getWorkerURL(
...
(Recorder.isRecordingSupported = function () {
	...
	return AudioContext && e && window.WebAssembly;
}),
	...
	(Recorder.prototype.initEncoder = function () {
		"function" == typeof registerProcessor
			...
			: ((this.encoderNode =
				...
				(this.encoderNode.onaudioprocess = ({
					inputBuffer: e,
				}) => this.encodeBuffers(e)),
				this.encoderNode.connect(
					this.audioContext.destination
				),
				(this.encoder = new window.Worker(
	...
	(Recorder.prototype.initWorker = function () {
		...
		return (
			...
			new Promise((t) => {
				var o = ({ data: i }) => {
					switch (i.message) {
						case "ready":
							...
							break;
						case "page":
							(this.encodedSamplePosition =
								i.samplePosition),
								e(i.page);
							break;
						case "done":
							this.encoder.removeEventListener(
								"message",
								o
							),
								this.finish();
				...
				this.encoder.addEventListener("message", o),
					this.encoder.start &&
						this.encoder.start();
				const { sourceNode: i, ...r } = this.config;
				this.encoder.postMessage(
					Object.assign(
						{
							command: "init",
	...
	(Recorder.prototype.initWorklet = function () {
		return "function" == typeof registerProcessor
			? this.audioContext.audioWorklet.addModule(
					this.encoderWorkerUrl
				)
			: Promise.resolve();
	}),
	(Recorder.prototype.pause = function (e) {
		if ("recording" === this.state)
			return (
				(this.state = "paused"),
				this.recordingGainNode.disconnect(),
	...
	(Recorder.prototype.setRecordingGain = function (e) {
				...
				this.audioContext
					...
					.then(() => {
						(this.state = "recording"),
							...
							this.recordingGainNode.connect(
								this.encoderNode
							),
							this.onstart();
					})
	...
	(Recorder.prototype.storePage = function (e) {
		this.recordedPages.push(e), (this.totalLength += e.length);
	}),
	(Recorder.prototype.streamPage = function (e) {
